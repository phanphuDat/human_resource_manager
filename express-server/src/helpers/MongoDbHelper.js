...
const DATABASE_NAME = 'HRM-web';
const CONNECTION_STRING = `mongodb+srv://manager:88ZSyHxxH4TVVO9Y@cluster0.038zb49.mongodb.net/${DATABASE_NAME}?retryWrites=true&w=majority`;
...
// ----------------------------------------------------------------------------
// FIND: Tìm kiếm (nhiều)
function findDocuments({ query = null, sort = null, limit = 500, aggregate = [], skip = 0, projection = null }, collectionName) {
  return new Promise((resolve, reject) => {
    MongoClient.connect(CONNECTION_STRING, { useNewUrlParser: true, useUnifiedTopology: true })
      .then((client) => {
        const dbo = client.db(DATABASE_NAME);
